...
NOTE: [A LITERATE HASKELL VERSION OF THIS ARTICLE EXISTS](SeeingTheRoundPegsAndTheSquareHoles.lhs)
...
Note: For the sake of being a one line statement (to mirror the Haskell expression) this C example uses [Compound Literal Syntax](https://en.wikipedia.org/wiki/C_syntax#Compound_literals) avalible since C99.
